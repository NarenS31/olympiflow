...
def build_master_table(results: Dict[Tuple[str, str], Optional[Dict[str, Any]]],
                       ...
                       out_tex: str, results_dir: str) -> Dict[str, Any]:
    ...
    lines = [
        ...
        r"not the city or the LLM---is what keeps the advisor grounded. PEMS-BAY and "
        r"Chicago use zero-shot transfer of the METR-LA model.}",
    ...
    for city in cities:
        ...
        for model in models:
            ...
            if v is None:
                ...
                cells.append(
                    r"\shortstack{{A {:.3f}\\B {:.3f}\\$\Delta$F1 {:+.3f}}}".format(
                        v["a_halluc"], v["b_halluc"], v["f1_gap"]))
